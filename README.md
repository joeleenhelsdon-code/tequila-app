...
TequilaFi is a mobile-friendly tequila discovery, collection and tasting-journal app.

## Cloudflare deployment

The app runs as a Vinext Cloudflare Worker with a D1 database.

1. Create a D1 database named `tequilafi-db`.
...
6. Attach `tequilafi.com` under the Worker's **Settings → Domains & Routes**.
